...
// 4-way parallel SHAKE128 Extendable Output Function using AVX2.
namespace shake128_x4 {
...
/**
 * 4-way parallel SHAKE128 XOF using AVX2.
 *
 * Operates on 4 independent SHAKE128 instances simultaneously, sharing the same
 * absorb/finalize/squeeze schedule. All 4 instances must absorb same-length messages
 * and squeeze the same number of bytes.
 */
struct shake128_x4_t
{
private:
...
public:
  forceinline shake128_x4_t() = default;
