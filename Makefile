...
benchmark: $(BENCHMARK_BINARY)
	...
	./$< --benchmark_min_warmup_time=.1 --benchmark_counters_tabular=true
...
perf: $(PERF_BINARY)
	...
	./$< --benchmark_min_warmup_time=.1 --benchmark_counters_tabular=true --benchmark_perf_counters=CYCLES,INSTRUCTIONS
